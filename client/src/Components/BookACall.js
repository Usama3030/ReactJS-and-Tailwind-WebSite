        ...
        {success ? (
          <div className="BookCall text-center my-32 w-5/6 lg:w-3/5 mx-auto">
            ...
            <p className="text-md mt-4 w-3/4 m-auto">
              Thanks for moooving toward change! We're excited you took the
              first step and booked time with our plant-passionate founder Eli.
              He's looking forward to chatting and seeing how we can help get
              your menus evolving in a healthier, sustainable direction.
            </p>
          ...
          <>
            <div className="BookCall text-center w-5/6 lg:w-3/5 mx-auto">
              ...
              <p className="text-md mt-4 w-3/4 m-auto">
                Ready to learn more? Get in touch! We would love to connect with
                you to understand your franchise goals and see how plant-based
                options can work for your business.
              </p>
              <p className="text-md font-bold mt-4 w-3/5 m-auto">
                Contact us by using the form below to schedule a free assessment
                or book a motivational speaking engagement with Eli.
              </p>
            </div>
