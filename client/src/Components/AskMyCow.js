      ...
      <div className="left w-full flex flex-col items-center pt-20 pl-8 md:pl-20 p-8">
        ...
        <div className="w-full ml-2 md:mt-[20px] md:ml-20">
          <img
            src={layer}
            alt="reload"
            className="w-[100%] h-20 md:w-[80%] md:h-40 "
          />
          <span className="absolute w-full my-[-60px] ml-12 md:my-[-120px] md:ml-10 text-xs md:text-lg lg:text-xl font-black font-AvenirNext">
